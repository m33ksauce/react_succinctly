 ...
 while (t);
          ...
          function Fr(n, t) {
            return function(r, e) {
              ...
              for (var u = r.length,
                  i = t ? u : -1,
                  o = Yu(r); (t ? i-- : ++i < u) && false !== e(o[i], i, o); )
                ;
              return r;
            };
          }
          ...
          function te(t, r, e, u) {
            function i() {
              for (var r = -1,
                  ...
                  l = u.length,
                  s = Vu(l + c),
                  h = this && this !== $n && this instanceof i ? f : t; ++a < l; )
                s[a] = u[a];
              for (; c--; )
                s[a++] = arguments[++r];
