...
var q = null,
    r = null,
    t = null,
    u = {injectComponentTree: function(a) {
        q = a.getFiberCurrentPropsFromNode;
        r = a.getInstanceFromNode;
        t = a.getNodeFromInstance;
      }};
function v(a) {
...
function y(a) {
  ...
  Array.isArray(b) ? p("103") : void 0;
  a.currentTarget = b ? t(c) : null;
  b = b ? b(a) : null;
...
function F(a, b, c) {
  if (b = E(a, c.dispatchConfig.phasedRegistrationNames[b]))
    c._dispatchListeners = B(c._dispatchListeners, b), c._dispatchInstances = B(c._dispatchInstances, a);
}
function G(a) {
  a && a.dispatchConfig.phasedRegistrationNames && A(a._targetInst, F, a);
}
function aa(a) {
...
function H(a) {
  if (a && a.dispatchConfig.registrationName) {
    ...
    if (b && a && a.dispatchConfig.registrationName) {
      var c = E(b, a.dispatchConfig.registrationName);
      c && (a._dispatchListeners = B(a._dispatchListeners, c), a._dispatchInstances = B(a._dispatchInstances, b));
    }
  }
}
var I = "dispatchConfig _targetInst nativeEvent isDefaultPrevented isPropagationStopped _dispatchListeners _dispatchInstances".split(" "),
    ba = {
      type: null,
      target: null,
...
function da(a) {
  a instanceof this ? void 0 : p("223");
  a.destructor();
...
var L = J.extend({touchHistory: function() {
    return null;
  }}),
    M = [],
    N = {
...
var S = {
  recordTouchTrack: function(a, b) {
    if (w(a))
      ...
      b.changedTouches.forEach(ea), N.numberActiveTouches = b.touches.length, 1 === N.numberActiveTouches && (N.indexOfSingleActiveTouch = b.touches[0].identifier);
    else if (v(a) && (b.changedTouches.forEach(ha), N.numberActiveTouches = b.touches.length, 1 === N.numberActiveTouches))
  ...
  responderTerminate: {registrationName: "onResponderTerminate"}
    ...
    Y = {
      ...
      extractEvents: function(a, b, c, f) {
        ...
        if (b && ("topScroll" === a && !c.responderIgnoreScroll || 0 < V && "topSelectionChange" === a || x(a) || w(a))) {
          var e = x(a) ? Z.startShouldSetResponder : w(a) ? Z.moveShouldSetResponder : "topSelectionChange" === a ? Z.selectionChangeShouldSetResponder : Z.scrollShouldSetResponder;
          if (U)
            b: {
              var d = U;
              for (var g = 0,
        ...
        if (a = d ? Z.responderTerminate : a ? Z.responderRelease : null)
          c = L.getPooled(a, U, c, f), c.touchHistory = S.touchHistory, D(c, H), e = T(e, c), X(null);
        c = S.touchHistory.numberActiveTouches;
        if (Y.GlobalInteractionHandler && c !== W)
...
(0, u.injectComponentTree)(k.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDOMComponentTree);
var ia = Object.freeze({
  injectComponentTree: u.injectComponentTree,
